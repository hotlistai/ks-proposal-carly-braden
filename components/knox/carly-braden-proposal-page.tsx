...
const ceremonyCoverageItems = [
  ...
  "Dedicated ceremony tech for ceremony management",
];
      ...
      <div className="mx-auto max-w-[1040px] px-9 pb-10 pt-20 md:px-[72px]">
        ...
        <FadeIn delay={150}>
          ...
          >
            ...
            <p>
              We loved hearing more about your wedding celebration at The Reserve at Marty B&apos;s on {config.eventDate}
              , and are excited to design an atmosphere that carries the evening naturally from cocktail hour into the
              reception.
            </p>
        ...
        <FadeIn delay={250}>
          <div className="mt-12">
            ...
            <VideoPlayer src={PREVIEW_VIDEO} poster={PREVIEW_VIDEO_POSTER} />
          </div>
        </FadeIn>
      </div>
    </header>
...
function MiddleVideoSection() {
  return (
    ...
    >
      <FadeIn>
        <VideoPlayer src={MIDDLE_VIDEO} poster={MIDDLE_VIDEO_POSTER} />
      </FadeIn>
    </section>
  );
}
      ...
      <FadeIn delay={250}>
        <div className="mt-12">
          <p className="max-w-[64ch] font-light" style={{ color: "rgba(255,255,255,0.72)", lineHeight: 1.75 }}>
            As the evening unfolds, the experience transitions into a DJ-led reception with live saxophone
            integration.
          </p>
        </div>
      </FadeIn>
...
function AddOnCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-[26px] font-semibold line-through" style={{ color: "rgba(255,255,255,0.36)" }}>
        {originalPrice}
      </p>
      <p
        className="mt-2 font-semibold"
        style={{ fontSize: "clamp(34px, 4vw, 48px)", letterSpacing: "-0.03em", color: "#ffffff" }}
      >
        {discountedPrice}
      </p>
      <p className="mt-6 font-light" style={{ color: "rgba(255,255,255,0.72)", lineHeight: 1.7 }}>
        This includes:
      </p>
...
function AddOnsSection() {
  return (
    ...
    >
      <FadeIn>
        <SectionLabel>A La Carte Add-On</SectionLabel>
        <h2
          className="font-bold"
          style={{
            fontSize: "clamp(28px, 3.5vw, 42px)",
      ...
      <FadeIn delay={175}>
        <div className="mt-12">
          <AddOnCard
            ...
            originalPrice={config.ceremonyCoverageOriginal}
            discountedPrice={config.ceremonyCoverageDiscounted}
            items={ceremonyCoverageItems}
          />
        </div>
      </FadeIn>
    </section>
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1.35fr_0.85fr]">
        <FadeIn delay={175}>
          ...
          >
            ...
            <p className="mt-5 text-[26px] font-semibold line-through" style={{ color: "rgba(255,255,255,0.36)" }}>
              {config.originalInvestment}
            </p>
            <p
              className="mt-3 m-0 font-semibold"
